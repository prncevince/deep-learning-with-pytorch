...
1. [Gradient Descent](chapter1_gradient-descent.ipynb)
2. [Stochastic Gradient Descent](chapter2_stochastic-gradient-descent.ipynb)
3. [Introduction to Pytorch & Neural Networks](chapter3_pytorch-neural-networks-pt1.ipynb)
4. [Training Neural Networks](chapter4_neural-networks-pt2.ipynb)
5. [Introduction to Convolutional Neural Networks](chapter5_cnns-pt1.ipynb)
6. [Advanced Convolutional Neural Networks](chapter6_cnns-pt2.ipynb)
7. [Advanced Deep Learning](chapter7_advanced-deep-learning.ipynb)
